...
class SlideListPage extends React.Component{
	constructor(props){
		super(props);
		this.data=[
			   {id:1,value:[{id:1,value:'财务收款',extra:'5天'},{id:2,value:'应收账款'},{id:3,value:'营业收入'},{id:4,value:'现金'},{id:5,value:'利润总额'}]},
	...
	render(){
		return <div>
               <SlideList canItemClick={false} style={{marginLeft:30,marginRight:30,marginTop:30}} data={this.data} text={'您要查询哪个组织的财务指标呢？'}
